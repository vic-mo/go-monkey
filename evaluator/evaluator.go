...
func evalIntegerInfixExpression(operator string, right object.Object, left object.Object) object.Object {
	...
	case ">":
		return nativeBoolToBooleanObject(leftVal > rightVal)
	case "==":
		return nativeBoolToBooleanObject(rightVal == leftVal)
	case "!=":
		return nativeBoolToBooleanObject(rightVal != leftVal)
	default:
		return newError("unknown operator: %s %s %s", left.Type(), operator, right.Type())
...
func evalStringInfixExpression(operator string, right object.Object, left object.Object) object.Object {
...
func evalProgram(stmts []ast.Statement, env *object.Environment) object.Object {
	...
	for _, statement := range stmts {
		...
		if returnValue, ok := result.(*object.Error); ok {
			return returnValue
		}
	}
	return result
